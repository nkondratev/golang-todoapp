...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_nkondratev_golang-todoapp_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
                    "500": {
        ...
        "/users": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Успешно получение списка пользователей",
                        "schema": {
                            "type": "array",
                            "items": {
    ...
    "definitions": {
        "github_com_nkondratev_golang-todoapp_internal_core_transport_http_response.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string",
