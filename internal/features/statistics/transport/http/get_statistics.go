...
type GetStatisticsResponse struct {
	...
	TasksAverageCompletionTime *string  `json:"tasks_average_completion_time" example:"1m30"`
}
...
func (h *StatisticHTTPHandler) GetStatistics(rw http.ResponseWriter, r *http.Request) {
